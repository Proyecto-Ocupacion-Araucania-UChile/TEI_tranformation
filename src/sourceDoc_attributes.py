...
class Attributes:
    ...
    def get_surface(self):
        ...
        att_list = self.root.find('.//a:Page', namespaces=self.NS).attrib
    ...
    def get_zone(self, parent, target):
        ...
        zone_elements = [z for z in self.root.findall(f'.//a:{parent}a:{target}', namespaces=self.NS) \
        ...
        for z in zone_elements:
            try:
                points.append(z.find('.//a:Polygon', namespaces=self.NS).attrib)
